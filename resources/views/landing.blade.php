...
@section('landing')
    <div class="section d-flex justify-content-center align-items-center">
        <div class="section-container p-5 d-flex flex-column align-items-end text-end mt-5">
            ...
            <button class="btn btn-dark rounded-5 px-4 py-2" onclick="window.location.href='/login';">Masuk</button>
        </div>
    </div>
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur quasi ad molestias harum porro aut quae cum nihil quibusdam quod, similique repellat molestiae nulla eveniet beatae magni ea natus. Tenetur?</p>
                    </div>
                </div>
            </div>
            <div class="col">
    ...
    <div class="container">
        <div class="row">
            ...
            dengan mudah. Trash-P adalah webiste yang diciptakan oleh sekelompok mahasiswa Jurusan Sistem Informasi
            Universitas Pembangunan Nasional Veteran Jawa Timur. Dengan Trash-P ini diharapkan bisa memudahkan Masyarakat
